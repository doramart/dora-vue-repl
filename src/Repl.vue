...
export interface Props {
  ...
  showSourceCodeBar?: boolean
  showCompileOutputBar?: boolean
...
const props = withDefaults(defineProps<Props>(), {
  ...
  showImportMap: true,
  showSourceCodeBar: true,
  showCompileOutputBar: true,
  showTsConfig: true,
  clearConsole: true,
  layoutReverse: false,
  ssr: false,
...
provide('compile-output-bar', toRef(props, 'showCompileOutputBar'))
provide('source-code-bar', toRef(props, 'showSourceCodeBar'))
